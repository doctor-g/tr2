...
\begin{abstract}
We present the context, design, and evaluation of 
...
There are nine
main characters as shown in Figure~\ref{fig:cast}, 
%
\begin{figure}\centering
\begin{framed}
...
\end{figure}
%
and at the start of the game, one is randomly chosen to be CEO, and
three more for your three employees.  
...
exploits, how many users are leaving because of them, and their progress
toward completion. 
\begin{figure}\centering
\begin{framed}
\includegraphics[width=2in]{images/features.png}
\includegraphics[width=2in]{images/exploits.png}
