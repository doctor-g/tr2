...
\textbf{---Everything below here is notes to be brought above into prose---}
...
If students separate academic and non-academic learning in a way imposed
by the state, they ironically 
become victims of it rather than liberally educated.



CS AS DEFAULT PATH is really problematic

Not knowing about software security: not so different from CS majors.


Two modes of decision-making: what does it mean for game design,
especially when these characters were all actually the same?

Several students recognized the role of the App Store 
and major software development companies in the software ecosystem.
To some, the path to a career in software development is 
through companies like Adobe or Apple.
% Impact?
