...
Finally, we return to the four research questions that framed this endeavor.
Our answers to these questions are based on local theories
developed through qualitative research methods. Hence, our answers
are grounded in our understanding of our subjects, and future work
would explore their generalizability.

\subsubsection*{What do youth think about software development?}

The subjects' perspectives of software development were colored by their
interests and computing ecology. Most were interested in games and 
generally referred to apps as ``games.'' Those with interests in art
or time management framed their perspective of software development
in that way. 
Their responses show the powerful cultural impact of brands such as
Apple, Adobe, and Minecraft, often building these up as exemplars
or gatekeepers, but they showed little reflection about the
social or philosophical implications of these entities.


Our subjects showed significant variation in how they perceived
the people who do software development, including positive and 
negative perspectives.



\subsubsection*{What do youth think about education and careers in technology?}

Most of our subjects understood that software development was
a viable career, based in part upon positive, age-appropriate
educational experiences with programming.
However, although a few recognized that there are multiple paths
to such careers, most displayed a troubling conflation of 
educational choice and future career. In particular, they overwhelmingly
see ``Computer Science'' as being \textit{the} path to becoming
a software developer, despite their not having a firm understanding
of what ``Computer Science'' really is beyond programming.
This matches the popular American discourse around higher education,
that its purpose is to prepare young workers.

We observed no material difference between how males and females
framed their discourse around software development.


\subsubsection*{What do youth think about security?}

Most subjects showed only passing familiarity with security concepts.


\subsubsection*{How does an educational game impact these?}

Playing \textit{Social Startup Game} provided an opportunity for these
subjects to participate in an simplified yet authentic simulation
of a social media software startup company.
It caused them to consider the impact of their decisions on 
the success of their company, particularly security- and education-related
decisions. 
